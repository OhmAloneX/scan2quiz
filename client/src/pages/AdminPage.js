  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        ...
        <div
          style={{
            padding: isMobile ? '20px 14px' : isTablet ? '24px 18px' : '24px 28px',
          }}
        >
          <div style={{ padding: isMobile ? 0 : 'clamp(16px,3vw,28px)' }}>
            {/* Message banner */}
            {message && (
              <div
                style={{
            ...
            {pendingCount > 0 && (
              ...
              >
                ...
                <div>
                  ...
                  >
                    {pendingCount} account{pendingCount > 1 ? 's' : ''} awaiting your
                    approval
                  </p>
                  <p
                    style={{
                  ...
                  >
                    Review and approve or reject teacher registration requests below
                  </p>
                </div>
                <button
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background: filter === tab.key ? 'rgba(34,211,238,0.12)' : 'transparent',
                    color: filter === tab.key ? '#22d3ee' : 'rgba(186,230,253,0.6)',
                    fontSize: 13,
            ...
            {loading ? (
              ...
              >
                <p style={{ color: 'rgba(186,230,253,0.5)' }}>Loading users...</p>
              </div>
            ) : filtered.length === 0 ? (
              <GlassCard style={{ textAlign: 'center', padding: 48 }}>
                ...
                <p style={{ color: 'rgba(186,230,253,0.4)', fontSize: 13 }}>
              ...
              <>
                <GlassCard>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 12, color: 'rgba(186,230,253,0.4)' }}>
                  ...
                  <div style={{ overflowX: 'auto' }}>
                    ...
                    >
                      <thead>
                        <tr>
                          {['Name', 'Email', 'Role', 'Status', 'Registered', 'Actions'].map(
                            (h) => (
                              <th
                                key={h}
                                style={{
                              ...
                              style={{
                                borderBottom:
                                  i < filtered.length - 1
                                    ...
                                    : 'none',
                                background: u.status === 'pending' ? 'rgba(251,191,36,0.03)' : 'transparent',
                              }}
                            >
                              {/* Name */}
                              ...
                              <td style={{ padding: '14px 12px' }}>
                                <span
                                  style={{
                                    ...
                                    color: u.role === 'admin' ? '#a5b4fc' : '#22d3ee',
                                  }}
                                >
                                  {u.role}
                                </span>
                ...
                {/* Pagination directly below the table container */}
